...
2. Set up 100 servers using the following template:
   - **Name**: "Farm Server"
   - **Channels**: "General"
3. Add the Ballsdex bot, 2 bots from Shape Inc. (https://platform.shapes.inc/). (The server member count must equal to 5, so add one more bot of your choice if needed)
